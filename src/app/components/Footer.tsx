...
{/* bottom */}
    ...
    <p className="text-sm text-[#9DA0AE] sm:ml-6 sm:mt-0 mt-4">
      ...
      <span className="flex flex-row sm:ml-auto sm:mt-0 mt-4 mr-[200px] justify-center sm:justify-start">

     <div className="w-5 h-5 " ><a href="#"><FaFacebook />
     </a></div> 
      <div className="w-5 h-5  ml-3 text-gray-900"><a href="#"><FaInstagram />
      </a></div>
